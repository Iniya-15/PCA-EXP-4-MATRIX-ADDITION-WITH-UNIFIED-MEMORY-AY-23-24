...
<h3> NAME: Iniya E</h3>
<h3> REGISTER NO: 212224230096</h3>
<h3>EX. NO: 4</h3>
...
<img width="1041" height="728" alt="Screenshot 2026-05-26 111511" src="https://github.com/user-attachments/assets/e98799e2-a266-430d-bb69-ba183c267a53" />


<img width="1094" height="808" alt="image" src="https://github.com/user-attachments/assets/d32d3a15-f886-4709-aea0-8f465323add8" />


## RESULT:

Thus the program has been executed by using unified memory. It is observed that removing the memset function has given less execution time (better performance).

With memset (unifmem1) → GPU time = 0.117445 sec
Without memset (unifmem2) → GPU time = 0.065132 sec

So, removing memset reduced the execution time significantly.
